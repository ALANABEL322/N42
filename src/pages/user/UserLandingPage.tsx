...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Benefits Section */}
      <Card className="bg-white shadow-lg rounded-xl overflow-hidden p-6 relative">
  ...
  <div className="flex flex-col items-center justify-center gap-8 md:gap-12 w-full max-w-96 text-center">
    ...
    <Button className="px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-md transition-colors">
      Get Started
    </Button>
  </div>
</div>
