...
const BrandIdentityPreview = lazy(
  () => import("./components/brandIdentityPreview/BrandIdentityPreview")
);
const ProjectDetailsView = lazy(
  () => import("./pages/dashboard/ProjectDetailsView")
);
const QuestionSelector = lazy(
  () => import("./components/questionSelector/QuestionSelector")
);
                ...
                <Routes>
                  ...
                  <Route element={<ProtectedRoute requiredRole="user" />}>
                    <Route element={<ProtectedLayout role="user" />}>
                      ...
                      />
                      <Route
                        path="/dashboard/support/question/:id"
                        element={<SupportUser />}
                      />
                      <Route
